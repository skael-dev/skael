...
- `internal/evalsuite/` — Suites are content-addressable archives stored beside skill bundles, so a score can be re-run later against the exact same tasks with a different panel.
